...
const airVentProducts: AirVentProduct[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Medium-sized air vent with snap fit design.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Medium-large air vent with screw fit design.',
    specifications: {
      ...
      dustFilter: '180 gsm, 10-15mm thick, 25-30 Micron',
      nutScrew: 'Mild steel (zinc plated)',
      suitableFans: '4" Sq. 120mm x 120mm x 38mm, 6" Sq. 172mm x 172mm x 55mm',
      density: 'Approximately 1.20 g/Cm³',
      approvals: 'CE, RoHS'
    }
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Extra large air vent with snap fit design.',
    specifications: {
      ...
      dustFilter: '180 gsm, 10-15mm thick, 25-30 Micron',
      nutScrew: 'Mild steel (zinc plated)',
      suitableFans: '6" Sq. 172mm x 172mm x 55mm, 6" Oval. 172mm x 150mm x 51mm, 8" Sq. 220mm x 220mm x 60mm',
      density: 'Approximately 1.20 g/Cm³',
      approvals: 'CE, RoHS'
    }
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Extra large air vent with snap fit design for industrial applications.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Doom type air vent with enhanced ventilation design.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Compact air vent with snap fit design for small applications.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Large doom type air vent with enhanced ventilation.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Small air vent with screw fit design for compact applications.',
    specifications: {
  ...
  },
  {
    ...
    inStock: true,
    image: '/api/placeholder/300/200',
    description: 'Large fan guard with circular opening for maximum airflow.',
    specifications: {
